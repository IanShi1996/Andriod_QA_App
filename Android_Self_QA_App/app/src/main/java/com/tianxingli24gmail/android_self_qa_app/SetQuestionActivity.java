...
public class SetQuestionActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE = "com.tianxingli24gmail.android_self_qa_app.MESSAGE";
    ...
    //will be passed in the view that was clicked
    public void setQuestion(View view) {
        Intent intent = new Intent(this, SetAnswerActivity.class);
